...
public class SpuInfoServiceImpl extends ServiceImpl<SpuInfoDao, SpuInfoEntity> implements SpuInfoService {
    ...
    public void up(Long spuId) {
        ...
        List<SkuEsModel> uoProducts = skus.stream().map(sku -> {
            ...
            esModel1.setBrandImg(sku.getSkuDefaultImg());
            //HasStock,hotScore
            //设置库存信息
            ...
            BrandEntity brand = brandService.getById(esModel1.getBrandId());
            esModel1.setBrandName(brand.getName());
            esModel1.setBrandImg(brand.getLogo());

            CategoryEntity category = categoryService.getById(esModel1.getCatalogId());
            esModel1.setCatalogName(category.getName());
